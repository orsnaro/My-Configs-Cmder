...
then
	...
	echo -e "[$(date)][INFO] activating virtual environment '~/pyenvs/discord_bot_ai_venv' ⌛"
	source /home/ors/pyenvs/discord_bot_ai_venv/bin/activate	
	echo -e "[$(date)][INFO] getting python version 'python3 -VV' ⌛"
	python3 -VV
